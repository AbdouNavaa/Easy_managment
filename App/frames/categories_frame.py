...
def show_categories_table(parent, limit=10,is_admin= 0):
    ...
    def update_table():
        ...
        for row_index, row in enumerate(data):
            ...
            for col_index, value in enumerate(row):
                ...
                label1.grid(row=row_index, column=4 if is_admin == 1 else 3, sticky="nsew", padx=5, pady=5)
    ...
    header_frame.columnconfigure((0,), weight=2, uniform='a') if is_admin == 1 else None
    ...
    # data_frame.columnconfigure((2,3), weight=3, uniform='a')   
    
    data_frame.columnconfigure(( 1, 4), weight=1, uniform='a')if is_admin == 1 else data_frame.columnconfigure((0,3), weight=1, uniform='a')
    data_frame.columnconfigure((0,), weight=2, uniform='a') if is_admin == 1 else None
