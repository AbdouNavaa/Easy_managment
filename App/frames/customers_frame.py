    ...
    def update_table():
        ...
        for row_index, row in enumerate(data):
            ...
            for col_index, value in enumerate(row):
                ...
                label1.grid(row=row_index, column=5 if is_admin == 1 else 4, sticky="nsew", padx=5, pady=1)
                ...
                edit_image_path = os.path.join(os.path.dirname(__file__), "images", "user (1).png")
                edit_image = ctk.CTkImage(light_image=Image.open(edit_image_path), size=(28, 28),)
                ...
                delete_image = ctk.CTkImage(light_image=Image.open(delete_image_path), size=(28, 28),)
