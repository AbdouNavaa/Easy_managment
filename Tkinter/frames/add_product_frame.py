...
def create_add_product_frame(root):
    ...
    name_entry.grid(sticky="news",row = 0, column = 1, ipady=10 , pady=2, padx=(10,0))
    ...
    desc_entry.grid(sticky="news",row = 0, column = 0, ipady=10 , pady=2, padx=(10,0))
    ...
    price_entry.grid(sticky="news",row = 0, column = 2,ipady=10 , pady=2, padx=(15,0),  )
    ...
    sell_price_entry.grid(sticky="news",row = 0, column = 1, ipady=10 , pady=2,padx=(15,0)  )
    ...
    buy_price_entry.grid(sticky="news",row = 0, column = 0, ipady=10 , pady=2, padx=(15,0),)
    ...
    code_entry.grid(sticky="news",row = 0, column =3,ipady=10 , pady=2, padx=(15,0),  )
    ...
    unit_entry.grid(sticky="news",row = 0, column = 2,ipady=10 , pady=2, padx=(15,0)  )
    ...
    qty_entry.grid(sticky="news",row = 0, column = 1,ipady=10 , pady=2, padx=(15,0),  )
    ...
    min_qty_entry.grid(sticky="news",row = 0, column = 0,ipady=10 , pady=2, padx=(15,0),  )
